...
SET search_path TO acp, cvl, public, common;
...
--
---- File: 002-create-contact.sql ----

SET search_path TO acp, cvl, public, common;

INSERT INTO acp.contact(contactid, contacttypeid)
VALUES (nextval('common.contact_contactid_seq'::regclass),
        3);

INSERT INTO acp.contactgroup(contactid, organization, name, acronym)
VALUES (currval('common.contact_contactid_seq'::regclass),
        TRUE,
...
VALUES ('acp',
        currval('common.contact_contactid_seq'::regclass),
        'Arctic Coastal Plain'
        );
