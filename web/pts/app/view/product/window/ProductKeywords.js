...
Ext.define('PTS.view.product.window.ProductKeywords', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.productkeywords',
    requires: [
            ...
            items: [
                {
                    ...
                    store: 'ProductKeywords',
                    columns: [{text: "Keyword", flex: 1, sortable: true, dataIndex: 'text'}],
